...
import com.cienet.np.config.Constants;
import com.cienet.np.NpwebappApp;
import com.cienet.np.domain.Authority;
import com.cienet.np.domain.User;
import com.cienet.np.repository.AuthorityRepository;
import com.cienet.np.repository.UserRepository;
import com.cienet.np.security.AuthoritiesConstants;
import com.cienet.np.service.MailService;
import com.cienet.np.service.dto.UserDTO;
import com.cienet.np.service.dto.PasswordChangeDTO;
import com.cienet.np.web.rest.errors.ExceptionTranslator;
import com.cienet.np.web.rest.vm.KeyAndPasswordVM;
import com.cienet.np.web.rest.vm.ManagedUserVM;
import com.cienet.np.service.UserService;
...
@SpringBootTest(classes = NpwebappApp.class)
