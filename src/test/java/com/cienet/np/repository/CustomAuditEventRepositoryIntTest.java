package com.cienet.np.repository;

import com.cienet.np.NpwebappApp;
import com.cienet.np.config.Constants;
import com.cienet.np.config.audit.AuditEventConverter;
import com.cienet.np.domain.PersistentAuditEvent;
...
import static com.cienet.np.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
